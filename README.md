...
- We test our approach in [WordCountToFileTest](https://github.com/kantarcise/learningspark/blob/main/src/test/scala/WordCountToFileTest.scala), which will help us another method of a Streaming Query: `processAllAvailable()`.
