...
object StreamingDeduplicationWithWatermark {
  ...
  def addDataPeriodicallyToMemoryStream(memoryStream: MemoryStream[Event],
    ...
    val sampleData: Seq[Event] = Seq(
      ...
      Event("862207ec-14d1-4671-9e61-56820f1a8b14", Timestamp.valueOf("2023-06-09 09:21:00"), "data1_duplicate"),
      Event("8562e978-54fd-4fc5-b70c-2b8f7e1346b5", Timestamp.valueOf("2023-06-09 10:20:00"), "data2_duplicate"),
      ...
      Event("862207ec-14d1-4671-9e61-56820f1a8b14", Timestamp.valueOf("2023-06-09 12:00:00"), "data1_duplicate2"),
